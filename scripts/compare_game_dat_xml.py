...
if __name__ == "__main__":
    ...
    archive_asia_set = {props.hash for props in iter_archiveorg_xml(archive_asia)}
    archive_usa_set = {props.hash for props in iter_archiveorg_xml(archive_usa)}
    archive_europe_set = {props.hash for props in iter_archiveorg_xml(archive_europe)}
