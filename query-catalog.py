...
if __name__ == "__main__":
	...
	parser.add_argument("--sort-by", metavar="COL", nargs="+", choices=fields.keys(), help="Sort output by column")
	parser.add_argument("--deleted", action="store_true", help="Return deleted files instead of existing ones")
